...
VlnPlot(object = Treg, 
        features = c("Tnfrsf8"), #also visualize Tnfrsf18, Lrrc32, Ctla4, Tigit
        pt.size = 0.5,
...
Treg.DE <- FindMarkers(noabseq, 
                       ident.1 = "ko_Treg",
                       ident.2 = "wt_Treg",
                       verbose = FALSE) #also perform on CD8Teff and CD4Teff
...
DEresult <- read.xlsx('TregDE.xlsx') #or CD8 Teff or CD4 Teff; available in Supplementary Table 3b-d
DEresult$DElabel <- NA
DEresult <- DEresult %>%
